    ...
    C.breakingNews = function(e, t) {
        ...
        s.children(".bn-label"))
          ...
          , k = function() {
            ...
            e <= -c.find("li:first-child").outerWidth() && (c.find("li:first-child").insertAfter(c.find("li:last-child")),
            c.css({
                marginLeft: 0
            })),
        ...
        o.init = function() {
                    ...
                    "rss2json" === o.settings.source.usingApi ? ((a = new XMLHttpRequest).onreadystatechange = function() {
                        if (4 == a.readyState && 200 == a.status) {
                            ...
                            for (var n = 0; n < e.items.length; n++)
                                o.settings.source.linkEnabled ? t += '<li><a target="' + o.settings.source.target + '" href="' + e.items[n].link + '">' + s + e.items[n][i] + "</a></li>" : t += "<li><a>" + s + e.items[n][i] + "</a></li>";
                            c.empty().append(t),
                            d = c.children("li"),
                            m = c.children("li").length,
                            y(),
                        ...
                        if (4 == r.readyState)
                            if (200 == r.status) {
                                ...
                                for (var n = 0; n < e.query.results.item.length; n++)
                                    o.settings.source.linkEnabled ? t += '<li><a target="' + o.settings.source.target + '" href="' + e.query.results.item[n].link + '">' + s + e.query.results.item[n][i] + "</a></li>" : t += "<li><a>" + s + e.query.results.item[n][i] + "</a></li>";
                                c.empty().append(t),
                                d = c.children("li"),
                                m = c.children("li").length,
                                y(),
            ...
            g.on("click", function() {
                p && (g.find("span").hasClass("bn-pause") ? (g.find("span").removeClass("bn-pause").addClass("bn-play"),
